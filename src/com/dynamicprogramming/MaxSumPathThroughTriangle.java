...
/**
 * Given a triangle, calculate the maximum sum of the values in the triangle
 ...
 * In this triangle, there's one element on row 1, 2 numbers on row 2, 3 numbers on row 3 and so on.
