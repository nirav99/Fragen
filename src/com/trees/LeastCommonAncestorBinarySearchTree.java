 ...
 *
 */
public class LeastCommonAncestorBinarySearchTree
{
  /**
   * Tree node
   * @author nirav99
   ...
   * Class constructor
   */
  public LeastCommonAncestorBinarySearchTree()
  {
    root = null;
    size = 0;
  }
  ...
  {
    LeastCommonAncestorBinarySearchTree t = new LeastCommonAncestorBinarySearchTree();
